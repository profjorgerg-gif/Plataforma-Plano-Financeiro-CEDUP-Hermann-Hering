...
const MANUAL_ALUNO_PASSOS = [
  ...
  { titulo: "Explorem a Análise de Cenários", texto: "Na aba \"Análise de Cenários\", criem até 3 simulações de \"e se\" (ex.: preço 10% maior, custo de matéria-prima 5% mais caro) sem alterar nada do que já foi lançado. É uma boa forma de testar decisões antes de aplicá-las de verdade nos módulos." },
...
const CHECKLIST_SECOES = [
  ...
  { titulo: "Pendente de confirmação", tom: "warn", itens: [
    "Testar o Gestor único e o login por matrícula com alunos reais usando ao mesmo tempo",
    "Avaliar bloqueio progressivo dos módulos (decisão ainda em aberto)",
            ...
            <div key={i} className="flex gap-4">
              ...
              <div className="pb-8 flex-1">
                ...
                {p.imagem && TELAS_MANUAL[p.imagem] && (
                  <img src={TELAS_MANUAL[p.imagem]} alt={p.titulo} className="w-full max-w-xl mt-3 rounded-lg border border-slate-700" />
                )}
              </div>
            </div>
          ))}
